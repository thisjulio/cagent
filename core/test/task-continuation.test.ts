...
describe("task continuation", () => {
  ...
  it("continues only after task state changes", () => {
    const tasks = createTasks([], ["Implement the feature", "Verify the feature"]);
