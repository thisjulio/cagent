...
const TASK_PROTOCOL = [
  ...
  "5. Use a batch operation to complete the current task and start the next one in one call:",
  ...
  "Never complete a task in a separate call when it is not already in_progress. If a task is pending, include its in_progress update before its completed update in the same batch.",
  "",
  "# Evidence",
