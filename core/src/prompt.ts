...
const PERSONA = [
  ...
  "The runtime executes tool calls sequentially. Keep dependent operations sequential and do not assume calls run concurrently.",
  "",
  "# Ground rules",
  ...
  "Prefer read/search tools for workspace inspection and use exact tool names and arguments from the schema.",
...
const TASK_PROTOCOL = [
  ...
  "",
  "1. The `tasks` tool accepts one direct operation per call: `create`, `add`, `list`, `next`, `skip`, `block`, `resume`, or `clear`.",
  ...
  '7. Use {"operation":"next","details":"evidence"} to complete the current task and start the next pending task.',
  ...
  '10. Use {"operation":"clear"} only after all work is complete and the list is no longer needed.',
