...
import { toChatMessages, type LlmCallOptions, type LlmChunk } from "@cagent/sdk";

export async function* streamApi(client: OpenAI, request: LlmCallOptions): AsyncGenerator<LlmChunk> {
